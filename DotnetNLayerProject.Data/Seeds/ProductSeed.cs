...
namespace DotnetNLayerProject.Data.Seeds
{
    class ProductSeed:IEntityTypeConfiguration<Product>
    {
        ...
        public void Configure(EntityTypeBuilder<Product> builder)
        {
            builder.HasData(
                ...
                new Product { Id = 4, Name = "Küçük Boy Defter", Price =12.50m, Stock = 200, CategoryId = _ids[1] },
                new Product { Id = 5, Name = "Orta Boy Defter", Price = 40.50m, Stock = 200, CategoryId = _ids[0] },
                new Product { Id = 6, Name = "Büyük Boy Defter", Price = 40.50m, Stock = 200, CategoryId = _ids[0] }
                );
        }
    }
}
